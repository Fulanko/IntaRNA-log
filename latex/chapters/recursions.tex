...
\begin{figure}[H]
	\centering
	\caption{Performance}
	\includegraphics[scale=0.41]{plot_exact.pdf}
\end{figure}

\begin{figure}[H]
	\centering
	\caption{Time \& memory}
	\includegraphics[scale=0.41]{plot_exact_info.pdf}
\end{figure}
...
\begin{figure}[H]
	\centering
	\caption{Performance}
	\includegraphics[scale=0.41]{plot_heuristic.pdf}
\end{figure}

\begin{figure}[H]
	\centering
	\caption{Time \& memory}
	\includegraphics[scale=0.41]{plot_heuristic_info.pdf}
\end{figure}
